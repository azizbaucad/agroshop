          ...
          <div className="flex ml-auto space-x-2  items-center justify-end">
            <form class="">
              ...
              <div class="relative">
                ...
                <button type="submit" class="hidden text-white absolute end-2.5 bottom-2.5 bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 me-2 mb-2">Search</button>
              </div>
            </form>
            <button type="button" class="transition-all duration-500 text-white  bg-green-700 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-white font-medium text-sm rounded-full px-5 py-2 text-center inline-flex items-center dark:focus:ring-gray-500 me-2 mb-2">
              Vendre un produit
            </button>
          </div>
          ...
          <nav className="contents">
            <ul className="flex space-x-2">
              <li className="relative inline-block">
                <a className="" href="">
                  <div className="absolute -top-1 right-0 z-10 bg-green-700 text-xs text-white font-bold px-1 py-0.5 rounded-full">12</div>
              ...
              <li className="relative inline-block">
                <a className="" href="">
                  <div className="absolute -top-1 right-0 z-10 bg-green-700 text-white text-xs font-bold px-1 py-0.5 rounded-full">30</div>
